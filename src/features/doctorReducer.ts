...
import { doctors } from '../../../serv/src/tempData';

// const initialState: IHashMap<IDoctor> | null = doctors;
...
const doctorsSlice = createSlice({
  ...
  reducers: {
    ...
    fetchDoctorsListSuccess: (userStateSlice, action: PayloadAction<IHashMap<IDoctor>>) => {
...
export const { addDoctor, deleteDoctor, fetchDoctorsListSuccess } = doctorsSlice.actions;
