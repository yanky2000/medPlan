...
import { clinics } from '../../../serv/src/tempData';

// const initialState: IHashMap<IClinic> | null = doctors;
...
export const postNewClinic = (newClionic: IClinic): IAppThunk => async dispatch => {
  try {
    // TODO: need type for response
